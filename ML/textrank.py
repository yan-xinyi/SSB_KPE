...
def init_args():
    ...
    parser.add_argument('--data_type', '-dt', default='train', type=str, help='Type of data.')
...
if __name__ == "__main__":
    ...
    save_path = os.path.join("./datas", args.dataset_name, 'textrank/results_%s2.json' % corpus_type)
